...
socket.onopen = async function(e){
    console.log('open',e);
    send_message_form.on('submit',selector_func);
...
// Need to create consumer that accepts websocket connection and connects frontend and backend
